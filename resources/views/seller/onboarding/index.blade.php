            ...
            <div class="bg-white rounded-lg border border-[#e7e7e7] overflow-hidden mb-4 shadow-sm">
                ...
                <div class="p-6 space-y-4">
                    <div>
                        ...
                        <input type="text" name="business_name" value="{{ old('business_name', isset($profile) ? $profile->
                        @if(isset($rejectedFields) && $rejectedFields->has('business_name'))
                            <p class="text-xs text-red-600 mt-1.5 font-semibold flex items-start"><i data-lucide="alert-circle" class="w-3.5 h-3.5 mr-1 shrink-0 mt-0.5"></i> <span>{{ $rejectedFields['business_name']->comment }}</span></p>
                        @endifbusiness_name ?? '' : '') }}" required
                    ...
                    <div>
                        ...
                        <input type="text" name="seller_brand_name" value="{{ old('seller_brand_name', isset($profile) ? $profile->
                        @if(isset($rejectedFields) && $rejectedFields->has('seller_brand_name'))
                            <p class="text-xs text-red-600 mt-1.5 font-semibold flex items-start"><i data-lucide="alert-circle" class="w-3.5 h-3.5 mr-1 shrink-0 mt-0.5"></i> <span>{{ $rejectedFields['seller_brand_name']->comment }}</span></p>
                        @endifseller_brand_name ?? '' : '') }}"
                    ...
                    <div>
                        ...
                        <textarea name="business_description" rows="3" class="w-full px-3 py-2.5 border border-gray-300 rounded-lg text-sm text-[#0f1111] focus:border-[#007185] focus:ring-1 focus:ring-[#007185] outline-none transition-colors" placeholder="Tell us about your business...">
                        @if(isset($rejectedFields) && $rejectedFields->has('business_description'))
                            <p class="text-xs text-red-600 mt-1.5 font-semibold flex items-start"><i data-lucide="alert-circle" class="w-3.5 h-3.5 mr-1 shrink-0 mt-0.5"></i> <span>{{ $rejectedFields['business_description']->comment }}</span></p>
                        @endif{{ old('business_description', isset($profile) ? $profile->business_description ?? '' : '') }}</textarea>
                    </div>
                    <div>
                        ...
                        @if(isset($rejectedFields) && $rejectedFields->has('business_category'))
                            <p class="text-xs text-red-600 mt-1.5 font-semibold flex items-start"><i data-lucide="alert-circle" class="w-3.5 h-3.5 mr-1 shrink-0 mt-0.5"></i> <span>{{ $rejectedFields['business_category']->comment }}</span></p>
                        @endif
            ...
            <div class="bg-white rounded-lg border border-[#e7e7e7] overflow-hidden mb-4 shadow-sm">
                ...
                <div class="p-6 space-y-4">
                    <div>
                        ...
                        <textarea name="business_address" rows="2" required class="w-full px-3 py-2.5 border border-gray-300 rounded-lg text-sm text-[#0f1111] focus:border-[#007185] focus:ring-1 focus:ring-[#007185] outline-none transition-colors" placeholder="Street address">
                        @if(isset($rejectedFields) && $rejectedFields->has('business_address'))
                            <p class="text-xs text-red-600 mt-1.5 font-semibold flex items-start"><i data-lucide="alert-circle" class="w-3.5 h-3.5 mr-1 shrink-0 mt-0.5"></i> <span>{{ $rejectedFields['business_address']->comment }}</span></p>
                        @endif{{ old('business_address', isset($profile) ? $profile->address ?? '' : '') }}</textarea>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        @if(isset($rejectedFields) && $rejectedFields->has('country'))
                            <p class="text-xs text-red-600 mt-1.5 font-semibold flex items-start"><i data-lucide="alert-circle" class="w-3.5 h-3.5 mr-1 shrink-0 mt-0.5"></i> <span>{{ $rejectedFields['country']->comment }}</span></p>
                        @endif
                        ...
                        @if(isset($rejectedFields) && $rejectedFields->has('state'))
                            <p class="text-xs text-red-600 mt-1.5 font-semibold flex items-start"><i data-lucide="alert-circle" class="w-3.5 h-3.5 mr-1 shrink-0 mt-0.5"></i> <span>{{ $rejectedFields['state']->comment }}</span></p>
                        @endif
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="lga" value="{{ old('lga', isset($profile) ? $profile->
                        @if(isset($rejectedFields) && $rejectedFields->has('lga'))
                            <p class="text-xs text-red-600 mt-1.5 font-semibold flex items-start"><i data-lucide="alert-circle" class="w-3.5 h-3.5 mr-1 shrink-0 mt-0.5"></i> <span>{{ $rejectedFields['lga']->comment }}</span></p>
                        @endiflga ?? '' : '') }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="city" value="{{ old('city', isset($profile) ? $profile->
                        @if(isset($rejectedFields) && $rejectedFields->has('city'))
                            <p class="text-xs text-red-600 mt-1.5 font-semibold flex items-start"><i data-lucide="alert-circle" class="w-3.5 h-3.5 mr-1 shrink-0 mt-0.5"></i> <span>{{ $rejectedFields['city']->comment }}</span></p>
                        @endifcity ?? '' : '') }}"
                ...
                <div class="p-6 space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="full_name" value="{{ old('full_name', isset($profile) ? $profile->
                        @if(isset($rejectedFields) && $rejectedFields->has('full_name'))
                            <p class="text-xs text-red-600 mt-1.5 font-semibold flex items-start"><i data-lucide="alert-circle" class="w-3.5 h-3.5 mr-1 shrink-0 mt-0.5"></i> <span>{{ $rejectedFields['full_name']->comment }}</span></p>
                        @endifkyc->full_name ?? '' : '') }}" required
                        ...
                        <div>
                            ...
                            <input type="date" name="date_of_birth" value="{{ old('date_of_birth', isset($profile) ? $profile->
                        @if(isset($rejectedFields) && $rejectedFields->has('date_of_birth'))
                            <p class="text-xs text-red-600 mt-1.5 font-semibold flex items-start"><i data-lucide="alert-circle" class="w-3.5 h-3.5 mr-1 shrink-0 mt-0.5"></i> <span>{{ $rejectedFields['date_of_birth']->comment }}</span></p>
                        @endifkyc->date_of_birth ?? '' : '') }}" required
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        @if(isset($rejectedFields) && $rejectedFields->has('nationality'))
                            <p class="text-xs text-red-600 mt-1.5 font-semibold flex items-start"><i data-lucide="alert-circle" class="w-3.5 h-3.5 mr-1 shrink-0 mt-0.5"></i> <span>{{ $rejectedFields['nationality']->comment }}</span></p>
                        @endif
                        ...
                        <div>
                            ...
                            <div wire:ignore>
                                <input type="text" name="phone" id="phone_input" value="{{ old('phone', isset($profile) ? $profile->
                        @if(isset($rejectedFields) && $rejectedFields->has('phone'))
                            <p class="text-xs text-red-600 mt-1.5 font-semibold flex items-start"><i data-lucide="alert-circle" class="w-3.5 h-3.5 mr-1 shrink-0 mt-0.5"></i> <span>{{ $rejectedFields['phone']->comment }}</span></p>
                        @endifphone ?? '' : '') }}" required
                    ...
                    <div>
                        ...
                        <input type="text" name="residential_address" value="{{ old('residential_address', isset($profile) ? $profile->
                        @if(isset($rejectedFields) && $rejectedFields->has('residential_address'))
                            <p class="text-xs text-red-600 mt-1.5 font-semibold flex items-start"><i data-lucide="alert-circle" class="w-3.5 h-3.5 mr-1 shrink-0 mt-0.5"></i> <span>{{ $rejectedFields['residential_address']->comment }}</span></p>
                        @endifkyc->residential_address ?? '' : '') }}" required
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            ...
                            <input type="text" name="nin" value="{{ old('nin', isset($profile) ? $profile->
                        @if(isset($rejectedFields) && $rejectedFields->has('nin'))
                            <p class="text-xs text-red-600 mt-1.5 font-semibold flex items-start"><i data-lucide="alert-circle" class="w-3.5 h-3.5 mr-1 shrink-0 mt-0.5"></i> <span>{{ $rejectedFields['nin']->comment }}</span></p>
                        @endifnin ?? '' : '') }}" required maxlength="11"
                        ...
                        @if(isset($rejectedFields) && $rejectedFields->has('id_type'))
                            <p class="text-xs text-red-600 mt-1.5 font-semibold flex items-start"><i data-lucide="alert-circle" class="w-3.5 h-3.5 mr-1 shrink-0 mt-0.5"></i> <span>{{ $rejectedFields['id_type']->comment }}</span></p>
                        @endif
                        ...
                        <div>
                            ...
                            <input type="text" name="id_number" value="{{ old('id_number', isset($profile) ? $profile->
                        @if(isset($rejectedFields) && $rejectedFields->has('id_number'))
                            <p class="text-xs text-red-600 mt-1.5 font-semibold flex items-start"><i data-lucide="alert-circle" class="w-3.5 h-3.5 mr-1 shrink-0 mt-0.5"></i> <span>{{ $rejectedFields['id_number']->comment }}</span></p>
                        @endifkyc->id_number ?? '' : '') }}" required

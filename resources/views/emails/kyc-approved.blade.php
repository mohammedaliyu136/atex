...
@section('title', 'Your Account Verification is Complete')
...
@section('content')
    ...
    <p>Congratulations! Your <strong>{{ ucfirst($profileType) }}</strong> profile verification has been successfully completed.</p>
    
    <p>You can now access all features of your account on the <strong>Adamawa Ecommerce platform</strong>.</p>

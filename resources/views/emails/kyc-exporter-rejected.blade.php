...
@section('title', 'Your Exporter Verification Needs Attention')
...
@section('content')
    ...
    <p>Your Exporter profile application has been reviewed, but we need you to address a few things before we can approve it.</p>
    ...
    <p>Please review your application information, ensure your NEPC certificate is valid, and resubmit.</p>

    <div style="text-align: center; margin-top: 32px;">
        <a href="{{ url('/seller/become-an-exporter') }}" class="button" style="background-color: #ef4444;">Review Verification Status</a>
    </div>
